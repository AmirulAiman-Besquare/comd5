...
export const ActivitySummary = () => {
  ...
  return (
    <>
      <div className="h-full bg-[#075F93] m-2  p-4 rounded xl:rounded-xl xl:w-96">
        <p className="mb-3 text-2xl text-white">Activity Summary</p>
        <div className=" h-full rounded-lg bg-[#122746] text-white ">
          <div className="flex w-full mb-10">
            <a href="/transactionhistory" className="mt-6 grow">
              <div className="bg-[#03C5BE]  rounded-xl mx-6 h-28 transition duration-500 transform hover:scale-110">
                <p className="pt-3 text-6xl text-center">{buy}</p>
                <p className="text-2xl text-center">BUY</p>
              </div>
            </a>
            <a href="/transactionhistory" className="mt-6 grow">
              <div className="bg-[#F2726F]  rounded-xl mx-6 h-28 transition duration-500 transform hover:scale-110">
          ...
          <div className="flex">
            <a href="/wallet" className="mb-6 grow">
              <div className="bg-[#4761A4]  rounded-xl mx-6 h-28 transition duration-500 transform hover:scale-110">
                <p className="pt-3 text-6xl text-center">{topup}</p>
                <p className="text-2xl text-center">TOPUP</p>
              </div>
            </a>
            <a href="/wallet" className="mb-6 grow">
              <div className="bg-[#2FAFE5]  rounded-xl mx-6 h-28 transition duration-500 transform hover:scale-110">
